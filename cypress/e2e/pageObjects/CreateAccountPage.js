export class CreateAccountPage{
    ...
    enterPassword(passwordInput){
        this.createAccountgPageElements.passwordInput().should('be.enabled').type(passwordInput);
    }

    retypePassword(passwordInput){
        this.createAccountgPageElements.retypePasswordInput().should('be.enabled').type(passwordInput);
    }
